...
BEGIN;
    ...
    GRANT ALL ON SCHEMA curator TO :v2;
	...
	GRANT ALL ON SCHEMA curator TO :v1;
    --Grant permissions for sequences within the schema.

    -- ???
    -- TODO: Do we need to grant ALL here ????
    GRANT ALL ON ALL SEQUENCES IN SCHEMA curator TO :v1;
